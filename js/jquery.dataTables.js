    ...
    (function(i) {
        ...
        var l = function(h) {
            ...
            function Oa(a) {
                ...
                c = c.indexOf("_INPUT_") !==
                    -1 ? c.replace("_INPUT_", '<input type="text" class="form-control" />') : c === "" ? '<input type="text" class="form-control" />' : c + ' <input type="text" class="form-control" style="display: inherit; width: auto;"label label-default />';
            ...
            function Na(a) {
                ...
                var b = '<select size="1" class="form-control" style="display: inherit; width: auto;" ' + ('name="' + a.sTableId + '_length"') + ">",
                    c, d, e = a.aLengthMenu;
            ...
            this.each(function() {
                ...
                if (this.nodeName.toLowerCase() != "table") O(null, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
                    ...
                    else g.oFeatures.bDeferRender && J(g, "aoDrawCallback", ba, "defer_sort_classes");
                    if (h.bJQueryUI) {
        ...
        i.extend(l.ext.oStdClasses, {
            sTable: "dataTable",
            sPagePrevEnabled: "btn btn-default btn-xs",
            sPagePrevDisabled: "btn btn-default btn-xs",
            sPageNextEnabled: "btn btn-default btn-xs",
            sPageNextDisabled: "btn btn-default btn-xs",
            sPageJUINext: "",
            sPageJUIPrev: "",
