...
(function ($) {
    ...
    $.cleditor = {
        ...
        buttons: {
            ...
            "color,Цвет текста,forecolor,|" +
            "highlight,Цвет фона текста,hilitecolor,color|" +
            "removeformat,Удалить форматирование,|" +
            "bullets,Список с точками,insertunorderedlist|" +
            "numbering,Список с цифрами,insertorderedlist|" +
            "outdent,Уменьшить отступ,|" +
            "indent,Увеличить отступ,|" +
            "alignleft,Выравнивание по левому краю,justifyleft|" +
            "center,Выравнивание по центру,justifycenter|" +
            "alignright,Выравнивание по правому краю,justifyright|" +
            "justify,Выравнивание по ширине,justifyfull|" +
            "undo,Отменить,|" +
            "redo,Повторить,|" +
            "rule,Разделительная линия,inserthorizontalrule|" +
    ...
    function buttonClick(e) {
        ...
        if (buttonName === "source") {
            ...
            // Show the textarea
                ...
                editor.$frame.hide();
                editor.$area.show();
                buttonDiv.title = "Вернуться к визуальному редактированию.";
            }
            ...
            if (popupName) {
                ...
                if (popupName === "url") {
                    ...
                    if (buttonName === "link" && selectedText(editor) === "") {
                        showMessage(editor, "Для начала необходимо выделить текст.", buttonDiv);
                        return false;
                    }
    ...
    function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
        ...
        // URL
            ...
            $popup.html('<label>Введите URL:<br /><input type="text" value="http://" style="width:200px" /></label><br /><input type="button" value="Отправить" />');
            popupTypeClass = PROMPT_CLASS;
        }

        // Paste as Text
        else if (popupName === "pastetext") {
            $popup.html('<label>Вставить содержимое:<br /><textarea rows="3" style="width:200px"></textarea></label><br /><input type="button" value="Отправить" />');
            popupTypeClass = PROMPT_CLASS;
        }
